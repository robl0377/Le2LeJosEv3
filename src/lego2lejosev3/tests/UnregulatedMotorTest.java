...
import lego2lejosev3.pblocks.UnregulatedMotor;
...
public class UnregulatedMotorTest {
	...
	public static void main(String[] args) {
		...
		UnregulatedMotor mot = new UnregulatedMotor(gripMotorPort);
		log.fine("Created Unregulated Motor at Port " + mot.getPortName());
