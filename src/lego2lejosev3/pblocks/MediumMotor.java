...
public class MediumMotor {
	...
	/**
	 * Motor Rotation Block: measure the current degrees turned since the last reset.
	 * 
	 * @return the degrees.
	 */
	...
	/**
	 * Motor Rotation Block: measure the number of rotations turned since the last reset.
	 * 
