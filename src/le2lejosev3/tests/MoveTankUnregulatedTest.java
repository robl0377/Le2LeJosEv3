...
/**
 * Test for the move tank with unregulated motors.
 * NOTE: Be sure the motors can run freely.
 * 
 * @author Roland Blochberger
 */
public class MoveTankUnregulatedTest {

	private static Class<?> clazz = MoveTankUnregulatedTest.class;
	...
	public static void main(String[] args) {
		...
		MoveTankUnregulated mst = new MoveTankUnregulated(leftMotorPort, rightMotorPort);
