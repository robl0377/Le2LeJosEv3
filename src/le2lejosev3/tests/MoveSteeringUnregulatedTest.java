...
/**
 * Test for the move steering with unregulated motors.
 * NOTE: Be sure the motors can run freely.
 * 
 * @author Roland Blochberger
 */
public class MoveSteeringUnregulatedTest {

	private static Class<?> clazz = MoveSteeringUnregulatedTest.class;
